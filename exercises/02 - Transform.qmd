...
select(covid_testing, first_name)  #B
...
filter(covid_testing, result == "positive") #C
...
_________ %>% # name of data frame goes here
  filter(_______) %>% #logical statement defining orders where clinic_name is picu
